...
$_SESSION['tipo_login_google'] = 'motorista'; // Define o tipo de login como motorista
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<head>
    ...
    <title>MedCar - Login Motorista</title>
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-blue-900 to-blue-800 text-white shadow-md">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                <a href="/MedCar/index.php" class="flex items-center space-x-2 text-xl font-bold">
                    <i data-lucide="ambulance" class="h-6 w-6"></i>
                    <span>MedCar</span>
                </a>
                <div class="hidden md:flex space-x-6">
                    <a href="/MedCar/index.php" class="font-medium hover:text-teal-300 transition">Home</a>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="bg-teal-500 text-white p-8 text-center">
                    <h2 class="text-3xl font-bold mb-2">Acesso do Motorista</h2>
                    <p class="text-xl">Entre com sua conta MedCar Motorista</p>
                </div>
                <div class="flex flex-col md:flex-row">
                    <!-- Login Form -->
                    <div class="w-full md:w-1/2 p-8">
                        <form action="../area_motorista/dashboard_motoristas.php" method="post" id="login-form" class="space-y-6">
                            <div>
                                <label for="email" class="block text-sm font-medium text-gray-700">E-mail</label>
                                <input type="email" id="email" name="email" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500" placeholder="motorista@exemplo.com" required>
                            </div>
                            <div>
                        ...
                        <div class="mt-6 text-center">
                            <p class="text-sm text-gray-600">
                                Não tem conta?
                                <a href="/MedCar/cadastro_motorista.php" class="font-medium text-teal-500 hover:text-teal-600">Cadastre-se como motorista</a>
                            </p>
                        </div>
                    </div>
                    <!-- Benefits -->
                    <div class="w-full md:w-1/2 bg-gray-50 p-8">
                        <h4 class="text-xl font-bold mb-4 text-gray-800">Vantagens para Motoristas</h4>
                        <ul class="space-y-2 mb-8 border-l-4 border-teal-500 pl-4">
                            <li>Receba corridas agendadas automaticamente</li>
                            <li>Gestão fácil de agenda e histórico</li>
                            <li>Pagamento transparente e detalhado</li>
                            <li>Suporte exclusivo para motoristas</li>
                        </ul>
                        <div class="mt-8">
