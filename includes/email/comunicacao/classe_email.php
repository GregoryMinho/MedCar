...
{
    private $mail;
    private $smtpHost = 'smtp.gmail.com'; // Host SMTP padrão
    private $smtpPort = 465; // Porta padrão para SMTP
    private $smtpUsername = 'medcartransportemedico@gmail.com'; // Usuário do e-mail que envia o e-mail
    private $smtpPassword = 'jren boiu nvpp gkav'; // Senha do e-mail ou token de autenticação
    ...
    public function send(): bool
    {
        try {
            if ($this->isSMTPEnabled) {
                $this->mail->isSMTP(true); // Habilita o envio SMTP
...
// $mailSenderSMTP = new EmailSender();
